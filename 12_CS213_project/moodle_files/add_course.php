    ...
    if(!empty($course_name) && !empty($course_code)){
        ...
        if(mysqli_query($dbc,$sql) && mysqli_query($dbc,$add_course)){
            ...
            if (!file_exists("G:\Remote_server\htdocs\SSL_1810\courses/$course_code")) {
                mkdir("G:\Remote_server\htdocs\SSL_1810\courses/$course_code/resources", 0777, true);
                mkdir("G:\Remote_server\htdocs\SSL_1810\courses/$course_code/assignments", 0777, true);
                mkdir("G:\Remote_server\htdocs\SSL_1810\courses/$course_code/tests", 0777, true);
                mkdir("G:\Remote_server\htdocs\SSL_1810\courses/$course_code/submissions", 0777, true);
            }
